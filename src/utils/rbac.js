...
export const PERMISSIONS = {
  admin: [
    ...
    MODULES.HISTORIAL, MODULES.USERS, MODULES.AUDIT,
  ...
  groomer: [
    ...
    MODULES.INVENTORY, MODULES.SERVICES, MODULES.CLIENTS, MODULES.HISTORIAL
  ],
  cliente: [
    MODULES.TIENDA, MODULES.RESERVAR, MODULES.HISTORIAL, MODULES.CLIENTS, MODULES.MASCOTAS
  ]
};
